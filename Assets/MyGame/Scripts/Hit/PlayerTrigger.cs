...
{
    void IRbVisitor<PlayerTrigger>.OnCollisionEnter(PlayerTrigger collision) => onCollisionEnterPlayerTrigger?.Invoke(collision);
    void IRbVisitor<PlayerTrigger>.OnCollisionExit(PlayerTrigger collision) => onCollisionExitPlayerTrigger?.Invoke(collision);
    void IRbVisitor<PlayerTrigger>.OnCollisionStay(PlayerTrigger collision) => onCollisionStayPlayerTrigger?.Invoke(collision);
    void IRbVisitor<PlayerTrigger>.OnTriggerEnter(PlayerTrigger collision) => onTriggerEnterPlayerTrigger?.Invoke(collision);
    void IRbVisitor<PlayerTrigger>.OnTriggerExit(PlayerTrigger collision) => onTriggerExitPlayerTrigger?.Invoke(collision);
    void IRbVisitor<PlayerTrigger>.OnTriggerStay(PlayerTrigger collision) => onTriggerStayPlayerTrigger?.Invoke(collision);

    public event Action<PlayerTrigger> onCollisionEnterPlayerTrigger;
    public event Action<PlayerTrigger> onCollisionExitPlayerTrigger;
    public event Action<PlayerTrigger> onCollisionStayPlayerTrigger;
    public event Action<PlayerTrigger> onTriggerEnterPlayerTrigger;
    public event Action<PlayerTrigger> onTriggerExitPlayerTrigger;
    public event Action<PlayerTrigger> onTriggerStayPlayerTrigger;
}

public partial class ExRbHit
{
    void IExRbVisitor<PlayerTrigger>.OnHitEnter(PlayerTrigger hit) => onHitEnterPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnBottomHitEnter(PlayerTrigger hit) => onBottomHitEnterPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnTopHitEnter(PlayerTrigger hit) => onTopHitEnterPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnLeftHitEnter(PlayerTrigger hit) => onLeftHitEnterPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnRightHitEnter(PlayerTrigger hit) => onRightHitEnterPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnHitStay(PlayerTrigger hit) => onHitStayPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnBottomHitStay(PlayerTrigger hit) => onBottomHitStayPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnTopHitStay(PlayerTrigger hit) => onTopHitStayPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnLeftHitStay(PlayerTrigger hit) => onLeftHitStayPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnRightHitStay(PlayerTrigger hit) => onRightHitStayPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnHitExit(PlayerTrigger hit) => onHitExitPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnBottomHitExit(PlayerTrigger hit) => onBottomHitExitPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnTopHitExit(PlayerTrigger hit) => onTopHitExitPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnLeftHitExit(PlayerTrigger hit) => onLeftHitExitPlayerTrigger?.Invoke(hit);
    void IExRbVisitor<PlayerTrigger>.OnRightHitExit(PlayerTrigger hit) => onRightHitExitPlayerTrigger?.Invoke(hit);

    public event Action<PlayerTrigger> onHitEnterPlayerTrigger;
    public event Action<PlayerTrigger> onBottomHitEnterPlayerTrigger;
    public event Action<PlayerTrigger> onTopHitEnterPlayerTrigger;
    public event Action<PlayerTrigger> onLeftHitEnterPlayerTrigger;
    public event Action<PlayerTrigger> onRightHitEnterPlayerTrigger;
    public event Action<PlayerTrigger> onHitStayPlayerTrigger;
    public event Action<PlayerTrigger> onBottomHitStayPlayerTrigger;
    public event Action<PlayerTrigger> onTopHitStayPlayerTrigger;
    public event Action<PlayerTrigger> onLeftHitStayPlayerTrigger;
    public event Action<PlayerTrigger> onRightHitStayPlayerTrigger;
    public event Action<PlayerTrigger> onHitExitPlayerTrigger;
    public event Action<PlayerTrigger> onBottomHitExitPlayerTrigger;
    public event Action<PlayerTrigger> onTopHitExitPlayerTrigger;
    public event Action<PlayerTrigger> onLeftHitExitPlayerTrigger;
    public event Action<PlayerTrigger> onRightHitExitPlayerTrigger;

    void SetInterpreterPlayerTrigger(IHitInterpreter hitInterpreter)
    {
        onHitEnterPlayerTrigger = hitInterpreter.OnHitEnter;
        onBottomHitEnterPlayerTrigger = hitInterpreter.OnBottomHitEnter;
        onTopHitEnterPlayerTrigger = hitInterpreter.OnTopHitEnter;
        onLeftHitEnterPlayerTrigger = hitInterpreter.OnLeftHitEnter;
        onRightHitEnterPlayerTrigger = hitInterpreter.OnRightHitEnter;
        onHitStayPlayerTrigger = hitInterpreter.OnHitStay;
        onBottomHitStayPlayerTrigger = hitInterpreter.OnBottomHitStay;
        onTopHitStayPlayerTrigger = hitInterpreter.OnTopHitStay;
        onLeftHitStayPlayerTrigger = hitInterpreter.OnLeftHitStay;
        onRightHitStayPlayerTrigger = hitInterpreter.OnRightHitStay;
        onHitExitPlayerTrigger = hitInterpreter.OnHitExit;
        onBottomHitExitPlayerTrigger = hitInterpreter.OnBottomHitExit;
        onTopHitExitPlayerTrigger = hitInterpreter.OnTopHitExit;
        onLeftHitExitPlayerTrigger = hitInterpreter.OnLeftHitExit;
        onRightHitExitPlayerTrigger = hitInterpreter.OnRightHitExit;
    }
}
