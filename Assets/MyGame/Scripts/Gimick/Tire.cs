...
{
    void IRbVisitor<Tire>.OnCollisionEnter(Tire collision) => onCollisionEnterTire?.Invoke(collision);
    void IRbVisitor<Tire>.OnCollisionExit(Tire collision) => onCollisionExitTire?.Invoke(collision);
    void IRbVisitor<Tire>.OnCollisionStay(Tire collision) => onCollisionStayTire?.Invoke(collision);
    void IRbVisitor<Tire>.OnTriggerEnter(Tire collision) => onTriggerEnterTire?.Invoke(collision);
    void IRbVisitor<Tire>.OnTriggerExit(Tire collision) => onTriggerExitTire?.Invoke(collision);
    void IRbVisitor<Tire>.OnTriggerStay(Tire collision) => onTriggerStayTire?.Invoke(collision);

    public event Action<Tire> onCollisionEnterTire;
    public event Action<Tire> onCollisionExitTire;
    public event Action<Tire> onCollisionStayTire;
    public event Action<Tire> onTriggerEnterTire;
    public event Action<Tire> onTriggerExitTire;
    public event Action<Tire> onTriggerStayTire;
}

public partial class ExRbHit
{
    void IExRbVisitor<Tire>.OnHitEnter(Tire hit) => onHitEnterTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnBottomHitEnter(Tire hit) => onBottomHitEnterTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnTopHitEnter(Tire hit) => onTopHitEnterTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnLeftHitEnter(Tire hit) => onLeftHitEnterTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnRightHitEnter(Tire hit) => onRightHitEnterTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnHitStay(Tire hit) => onHitStayTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnBottomHitStay(Tire hit) => onBottomHitStayTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnTopHitStay(Tire hit) => onTopHitStayTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnLeftHitStay(Tire hit) => onLeftHitStayTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnRightHitStay(Tire hit) => onRightHitStayTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnHitExit(Tire hit) => onHitExitTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnBottomHitExit(Tire hit) => onBottomHitExitTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnTopHitExit(Tire hit) => onTopHitExitTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnLeftHitExit(Tire hit) => onLeftHitExitTire?.Invoke(hit);
    void IExRbVisitor<Tire>.OnRightHitExit(Tire hit) => onRightHitExitTire?.Invoke(hit);

    public event Action<Tire> onHitEnterTire;
    public event Action<Tire> onBottomHitEnterTire;
    public event Action<Tire> onTopHitEnterTire;
    public event Action<Tire> onLeftHitEnterTire;
    public event Action<Tire> onRightHitEnterTire;
    public event Action<Tire> onHitStayTire;
    public event Action<Tire> onBottomHitStayTire;
    public event Action<Tire> onTopHitStayTire;
    public event Action<Tire> onLeftHitStayTire;
    public event Action<Tire> onRightHitStayTire;
    public event Action<Tire> onHitExitTire;
    public event Action<Tire> onBottomHitExitTire;
    public event Action<Tire> onTopHitExitTire;
    public event Action<Tire> onLeftHitExitTire;
    public event Action<Tire> onRightHitExitTire;

    void SetInterpreterTire(IHitInterpreter hitInterpreter)
    {
        onHitEnterTire = hitInterpreter.OnHitEnter;
        onBottomHitEnterTire = hitInterpreter.OnBottomHitEnter;
        onTopHitEnterTire = hitInterpreter.OnTopHitEnter;
        onLeftHitEnterTire = hitInterpreter.OnLeftHitEnter;
        onRightHitEnterTire = hitInterpreter.OnRightHitEnter;
        onHitStayTire = hitInterpreter.OnHitStay;
        onBottomHitStayTire = hitInterpreter.OnBottomHitStay;
        onTopHitStayTire = hitInterpreter.OnTopHitStay;
        onLeftHitStayTire = hitInterpreter.OnLeftHitStay;
        onRightHitStayTire = hitInterpreter.OnRightHitStay;
        onHitExitTire = hitInterpreter.OnHitExit;
        onBottomHitExitTire = hitInterpreter.OnBottomHitExit;
        onTopHitExitTire = hitInterpreter.OnTopHitExit;
        onLeftHitExitTire = hitInterpreter.OnLeftHitExit;
        onRightHitExitTire = hitInterpreter.OnRightHitExit;
    }
}
